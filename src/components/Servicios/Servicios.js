        ...
        <div class="col-lg-3">
          <ul class="nav nav-tabs flex-column">
            <li class="nav-item">
              ...
              <img src="./images/gallery-3.jpg" alt="" class="frame" />CUMPLEAÑOS</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#tab-2">
     
              <img src="./images/gallery-3.jpg" alt="" class="frame" /> ANIVERSARIO</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#tab-3">
     
              <img src="./images/gallery-3.jpg" alt="" class="frame" />FIESTAS INFANTILES</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#tab-4">
     
              <img src="./images/gallery-3.jpg" alt="" class="frame" /> DECLARACION / PROPUESTA</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#tab-5">
     
              <img src="./images/gallery-3.jpg" alt="" class="frame" />DESPEDIDAS</a>
            </li>
              <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#tab-6">
     
              <img src="./images/gallery-3.jpg" alt="" class="frame" />CENA CON AMIGOS</a>
            </li>
